...
import (
	...
	"github.com/stkr89/go-k8s-cognito-crud-microservice-template/config"
	"github.com/stkr89/go-k8s-cognito-crud-microservice-template/endpoints"
	v1 "github.com/stkr89/go-k8s-cognito-crud-microservice-template/pb"
	"github.com/stkr89/go-k8s-cognito-crud-microservice-template/service"
	transport "github.com/stkr89/go-k8s-cognito-crud-microservice-template/transports"
	"net"
	"net/http"
	"os"
	"os/signal"
